...
class AccountService:
    ...
    def get_transactions(self, db: Session, account_id: int):
    ...
    def deposit(self, db: Session, account_id: int, amount):
    ...
    def withdraw(self, db: Session, account_id: int, amount):
